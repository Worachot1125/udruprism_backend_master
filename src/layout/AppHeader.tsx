...
const AppHeader: React.FC = () => {
  ...
  // ⌘/Ctrl + K → focus search (และเปิดเมนู app บนจอเล็กให้เห็นช่อง)
  useEffect(() => {
  ...
  return (
    <header className="sticky top-0 z-99999 flex w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        {/* Right block: application actions */}
        <div
          id="app-header-actions"
          ref={appMenuRef}
          className={`${
            isApplicationMenuOpen ? "flex" : "hidden"
          } w-full items-center justify-between gap-4 px-5 py-4 shadow-theme-md lg:flex lg:justify-end lg:px-0 lg:py-4 lg:shadow-none`}
          aria-hidden={!isApplicationMenuOpen && typeof window !== "undefined" && window.innerWidth < 1024}
        >
